...
if (isset($_POST)) {
	...
	$sql = "INSERT INTO job_post(id_emp, jobtitle, description, minimumsalary, maximumsalary) VALUES ('$_SESSION[id_emp]','$jobtitle', '$description', '$minimumsalary', '$maximumsalary')";
