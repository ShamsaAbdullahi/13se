        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <?php
              $sql = "SELECT * FROM job_post INNER JOIN applyjob ON job_post.id_jobpost=applyjob.id_jobpost  INNER JOIN employees ON employees.id_user=applyjob.id_user WHERE applyjob.id_emp='$_SESSION[id_emp]'";
              ...
              ?>
                  <div class="attachment-block clearfix padding-2">
                    <h4 class="attachment-heading"><a href="user-application.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle'] . ' @ (' . $row['firstname'] . ' ' . $row['lastname'] . ')'; ?></a>
                    </h4>
