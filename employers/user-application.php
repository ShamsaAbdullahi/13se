...
$sql = "SELECT * FROM applyjob WHERE id_emp='$_SESSION[id_emp]' AND id_user='$_GET[id]'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 bg-white padding-2">
                            <div class="row margin-top-20">
                                <div class="col-md-12">
                                    <?php
                  $sql = "SELECT * FROM employees WHERE id_user='$_GET[id]'";
                  $result = $conn->query($sql);
                  ...
                  ?>
                                    ...
                                    <div class="pull-right">
                                        <a href="job-applications.php"
                                            class="btn btn-default btn-lg btn-flat margin-top-20"><i
