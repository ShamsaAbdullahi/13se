...
$sql = "SELECT * FROM mailbox WHERE id_mailbox='$_GET[id_mail]' AND (id_fromuser='$_SESSION[id_emp]' OR id_touser='$_SESSION[id_emp]')";
...
if ($result->num_rows >  0) {
  ...
  if ($row['fromuser'] == "employers") {
    ...
    $sql2 = "SELECT * FROM employees WHERE id_user='$row[id_fromuser]'";
    $result2 = $conn->query($sql2);
    if ($result2->num_rows >  0) {
      $rowUser = $result2->fetch_assoc();
    }
                                        ...
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body no-padding">
                                                <div class="mailbox-read-info">
                                                    ...
                                                    <h5>From: <?php echo $rowCompany['username']; ?>
                                                        <span
