                  ...
                  ?>
                      <div class="col-md-6 latest-job ">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" name="username" value="<?php echo $row['username']; ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label>Firstname</label>
                          <input type="text" class="form-control input-lg" name="firstname" value="<?php echo $row['firstname']; ?>" required="">
                        </div>
                        <div class="form-group">
                          <label>Lastname</label>
                          <input type="text" class="form-control input-lg" name="lastname" value="<?php echo $row['lastname']; ?>" required="">
                        </div>


                        <div class="form-group">
                          <button type="submit" class="btn btn-flat btn-success">Update Company
                            Profile</button>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-6 latest-job ">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="contactno" name="phone" placeholder="Contact Number" value="<?php echo $row['phone']; ?>">
                        </div>
                        <div class="form-group">
