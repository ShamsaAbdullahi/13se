...
if ($result->num_rows >  0) {
  ...
  if ($row['fromuser'] == "employers") {
    $sql1 = "SELECT * FROM employers WHERE id_emp='$row[id_fromuser]'";
    $result1 = $conn->query($sql1);
    if ($result1->num_rows >  0) {
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM employees WHERE id_user='$row[id_touser]'";
    $result2 = $conn->query($sql2);
    if ($result2->num_rows >  0) {
      $rowUser = $result2->fetch_assoc();
    }
  } else {
    $sql1 = "SELECT * FROM employers WHERE id_emp='$row[id_touser]'";
    $result1 = $conn->query($sql1);
    if ($result1->num_rows >  0) {
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM employers WHERE id_user='$row[id_fromuser]'";
    $result2 = $conn->query($sql2);
    if ($result2->num_rows >  0) {
      $rowUser = $result2->fetch_assoc();
    }
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body no-padding">
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li><a href="index.php"><i class="fa fa-address-card-o"></i> My Applications</a>
                                        </li>
                                        <li class="active"><a href="mailbox.php"><i class="fa fa-envelope"></i>
                                                Mailbox</a></li>
                                        ...
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body no-padding">
                                                <div class="mailbox-read-info">
                                                    ...
                                                    <h5>From: <?php if ($row['fromuser'] == "employer") {
                                      echo $rowCompany['username'];
                                    } else {
                    ...
                    ?>
                                        <div class="box box-primary">
                                            <div class="box-body no-padding">
                                                <div class="mailbox-read-info">
                                                    <h3>Reply Message</h3>
                                                    <h5>From: <?php if ($rowReply['usertype'] == "employers") {
                                          echo $rowCompany['username'];
                                        } else {
                                          echo $rowUser['firstname'];
                                        } ?>
                                            ...
                                            <div class="box-body no-padding">
                                                ...
                                                <div class="mailbox-read-message">
                                                    <form action="reply-mailbox.php" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit"
                                                                class="btn btn-flat btn-success">Reply</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- /.mailbox-read-message -->
