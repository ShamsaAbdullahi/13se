    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.php" class="logo logo-bg">
                ...
                <span class="logo-lg"><b>Blue Collar Services </b> Portal</span>
            </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        ?>
                                ...
                                ?>
                                                        <a
                                                            href="reject-company.php?id=<?php echo $row['id_emp']; ?>">Reject</a>
                                                        <a
                                                            href="approve-company.php?id=<?php echo $row['id_emp']; ?>">Approve</a>
                                                        <?php
                                } else if ($row['active'] == '3') {
                                ?>
                                                        <a
                                                            href="approve-company.php?id=<?php echo $row['id_emp']; ?>">Reactivate</a>
                                                        <?php
                                ...
                                ?>
                                                    ...
                                                    <td><a
                                                            href="delete-company.php?id=<?php echo $row['id_emp']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                          }
