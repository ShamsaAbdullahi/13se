...
if(isset($_POST)) {
	...
	if($uploadOk == false) {
		...
		$sql = "INSERT INTO users(firstname, lastname, email, password, city, contactno, qualification,  dob, age, aboutme, skills) VALUES ('$firstname', '$lastname', '$email', '$password',  '$city',  '$contactno', '$qualification',  '$dob', '$age', '$aboutme', '$skills')";
