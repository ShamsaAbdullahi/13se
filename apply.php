...
if (isset($_GET)) {
    ...
    $sql1 = "SELECT * FROM applyjob WHERE id_user='$_SESSION[id_user]' AND id_jobpost='$row[id_jobpost]'";
    $result1 = $conn->query($sql1);
    if ($result1->num_rows == 0) {

        $sql = "INSERT INTO applyjob(id_jobpost, id_emp, id_user) VALUES ('$_GET[id]', '$id_emp', '$_SESSION[id_user]')";
